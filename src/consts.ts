...
export const AURA_MIN_FATNESS = 0.8; // shown fatness where the max-fat gold aura fades in/out
export const AURA_SPAWN_INTERVAL = 0.15; // seconds between aura sparkle spawns
